...
public class BorderManager implements Listener {
	...
	public BorderManager(UHCDeathMatch main) {
		...
		stages.add(new BorderStage(0, main.getConfig().getInt("settings.border.1.timer"), main.getConfig().getInt("settings.border.1.size")));
		stages.add(new BorderStage(0, main.getConfig().getInt("settings.border.2.timer"), main.getConfig().getInt("settings.border.2.size")));
	}
